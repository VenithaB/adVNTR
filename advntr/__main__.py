...
def main():
    ...
    usage = "\r{}\nusage: %(prog)s <command> [options]\n\n\r{}\r{}".format(
        description.ljust(len("usage:")), help, "\n"
    )
    ...
    genotype_io_group.add_argument(
        "-a",
        "--alignment_file",
        type=str,
        metavar="<file>",
    ...
    genotype_io_group.add_argument(
        ...
        metavar="<format>",
        default="text",
        choices=outfmt_choices,
        help="output format. Allowed values are {"
        + ", ".join(outfmt_choices)
        + "} [%(default)s]",
    )
    genotype_io_group.add_argument(
    ...
    genotype_algortihm_group.add_argument(
        "-fs",
        "--frameshift",
        action="store_true",
    ...
    genotype_others_group.add_argument(
    ...
    viewmodel_parser = subparsers.add_parser(
        "viewmodel", usage="advntr viewmodel [options]", formatter_class=fmt
    )
    viewmodel_parser.add_argument(
        "-g",
        "--gene",
        type=str,
        default="",
    ...
    addmodel_parser = subparsers.add_parser(
        "addmodel",
    ...
    addmodel_args_group.add_argument(
        "-r",
        "--reference",
        type=str,
        default=None,
    ...
    addmodel_other_group.add_argument(
        "-g", "--gene", type=str, default=None, metavar="<text>", help="Gene name"
    )
    addmodel_other_group.add_argument(
        "-a",
        "--annotation",
    ...
    delmodel_parser = subparsers.add_parser(
        "delmodel",
    ...
    delmodel_args_group.add_argument(
        "-vid", "--vntr_id", type=str, metavar="<text>", default=None, help="VNTR ID"
    )

    delmodel_other_group.add_argument(
        "-m",
        "--models",
        type=str,
        default=None,
